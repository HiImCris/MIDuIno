...
Implementar inversão da leitura dos potenciômetros a partir de click no joystick (push button). (Excluir pots A1 e A2 (além do bend), pois a ideia é implementar essa função só para meus sliders.}
